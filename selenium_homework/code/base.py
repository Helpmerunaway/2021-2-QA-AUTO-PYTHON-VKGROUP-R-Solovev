...
class BaseCase:
    ...
    def replace_text(by_locator, text):
        """
        Подстановка текста в локатор вместо символов {}
        """
        by = by_locator[0]
        locator = by_locator[1]
        edited_locator = locator[:locator.find('{')] + str(text) + locator[
                                                                   locator.rfind('}') + 1:]
        return by, edited_locator